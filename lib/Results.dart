class Results {
  ...
  factory Output1.fromJson(Map<String, dynamic> json) {
    return Output1(
      ...
      scoredProbabilitiesForClass0: json['Scored Probabilities for Class "0"'] as String,
      scoredProbabilitiesForClass1: json['Scored Probabilities for Class "1"'] as String,
